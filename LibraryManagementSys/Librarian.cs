...
{// Chloe Caplan
    public class Librarian
    {
        ...
        public Librarian(int employeeId, string librarianName, string position, int tenure, string library, DateTime hireDate)
        {
            ...
            this.tenure = HireDateGenerator(hireDate);
        }
        ...
        //Calculate 
        private int HireDateGenerator(DateTime hireDate)
        {
            DateTime current = DateTime.Now;
            int currentYear = current.Year;
            int tenure = (currentYear - hireDate.Year);
            return tenure;
